        ...
        <div class="card bg-dark text-white" style="border-radius: 1rem;">
          <div class="card-body p-5 text-center">
            ...
            <div class="mb-md-5 mt-md-4 pb-5">
              ...
              <p class="text-white-50 mb-5">Ingrese su correo y contraseña para acceder</p>
            ...
            <div>
              <p class="mb-0">No tienes una cuenta? <a href="{{route('register')}}" class="text-white-50 fw-bold">Registrate</a>
              </p>
            </div>
